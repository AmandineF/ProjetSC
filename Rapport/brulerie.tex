...
\lstinputlisting[caption=Récupération des réponses]{./Codes/couper1.py}
\textbf{Envoi des paquets}~\\
\lstinputlisting[caption=Récupération des réponses]{./Codes/couper2.py}
\textbf{Sniff}~\\
\lstinputlisting[caption=Récupération des réponses]{./Codes/couper3.py}


\subsubsection{Sniffer}

\textbf{Man in the middle}~\\
\lstinputlisting[caption=Récupération des réponses]{./Codes/attaque.py}
\textbf{Ecoute}~\\
\textit{Sniff}~\\
\lstinputlisting[caption=Récupération des réponses]{./Codes/ecoute1.py}
