...
def usage(): print "Usage: python newtry.py [-h | --help] [-v | --verbose] [-t | --display-time] interface mac_host1_addr IPv6_host1_lladdr mac_host2_addr IPv6_host2_lladdr host1_rtrflag host2_rtrflag\n\nThis script is under CC LICENSE 3.0 BY-NC-SA.\n\nFeel free to report any bug or suggestion to <ben@bashy.eu>."
